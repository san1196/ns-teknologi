            ...
            <div class="card">
				...
				<div class="card-body">
                    ...
                    <form method="post" action="/product/update/{{ $product->id }}" enctype="multipart/form-data">
						...
						<div class="form-group">
                            <label>Judul</label>
                            <input name="judul" type="text" class="form-control" placeholder="Judul System Product..." value="{{ $product->judul }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="keterangan" type="text" class="form-control" placeholder="Keterangan System Product..."> {{ $product->keterangan }} </textarea>
