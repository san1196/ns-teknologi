				...
				<div class="card-body">
                    ...
                    <form method="post" action="/contact/update/{{ $contact->id }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="lokasi" type="text" class="form-control" placeholder="Lokasi untuk Google Maps"> {{ $contact->lokasi }} </textarea>
                        ...
                        <div class="form-group">
                            <label>Alamat</label>
                            <textarea name="alamat" type="text" class="form-control" placeholder="Alamat"> {{ $contact->alamat }} </textarea>
                        ...
                        <div class="form-group">
                            <label>Telepon</label>
                            <input name="telepon" type="text" class="form-control" placeholder="Telepon" value="{{ $contact->telepon }}">
